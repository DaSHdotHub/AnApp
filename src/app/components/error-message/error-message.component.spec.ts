...
describe('ErrorMessageComponent', () => {
  ...
  it('should hide error message when field not touched', () => {
    component.field = new FormGroup({anyField: new FormControl()});
  ...
  it('should hide error message when field touched, but no errors', () => {
    component.field = new FormGroup({anyField: new FormControl()});
  ...
  it('should hide error message on field touched and has error, but different error', () => {
    component.field = new FormGroup({anyField: new FormControl()});
